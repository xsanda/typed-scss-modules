...
describe("main", function () {
    ...
    test("generates types for all .scss files when the pattern is a directory", function () { return __awaiter(_this, void 0, void 0, function () {
        var pattern;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pattern = "" + __dirname;
                    return [4 /*yield*/, main_1.main(pattern, {
                            watch: false,
                            exportType: "named",
                            listDifferent: false
                        })];
