...
exports.main = function (pattern, options) { return __awaiter(_this, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                ...
                if (fs_1.default.existsSync(pattern) && fs_1.default.lstatSync(pattern).isDirectory()) {
                    ...
                    pattern = path_1.default.resolve(pattern, "**/*.scss");
                }
                if (options.listDifferent) {
                    core_1.listDifferent(pattern, options);
                    return [2 /*return*/];
                }
                if (!options.watch) return [3 /*break*/, 1];
                core_1.watch(pattern, options);
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, core_1.generate(pattern, options)];
            case 2:
                _a.sent();
                _a.label = 3;
