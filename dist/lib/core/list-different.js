...
exports.listDifferent = function (pattern, options) { return __awaiter(_this, void 0, void 0, function () {
    var files;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all(files.map(function (file) { return exports.checkFile(file, options); })).then(function (results) {
...
exports.checkFile = function (file, options) {
    return new Promise(function (resolve) {
        return sass_1.fileToClassNames(file, options).then(function (classNames) {
            ...
            var content = fs_1.default.readFileSync(path, { encoding: "UTF8" });
